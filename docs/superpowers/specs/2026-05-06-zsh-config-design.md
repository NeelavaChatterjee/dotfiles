...
- **Public-shareable** — corp-internal context isolated to a gitignored work file.
...
# Gitignored — corp-internal stuff lives here.
# Examples:
# export AWS_PROFILE=...
...
5. The repo contains no corp-internal hostnames, context names, account IDs, or aliases.
